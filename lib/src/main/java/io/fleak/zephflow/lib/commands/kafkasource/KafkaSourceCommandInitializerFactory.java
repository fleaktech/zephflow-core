...
public class KafkaSourceCommandInitializerFactory
  ...
  public KafkaSourceCommandInitializerFactory(
  ...
  protected CommandPartsFactory createCommandPartsFactory(
    ...
    return new KafkaSourceCommandPartsFactory(metricClientProvider, kafkaConsumerClientFactory);
  }
}
