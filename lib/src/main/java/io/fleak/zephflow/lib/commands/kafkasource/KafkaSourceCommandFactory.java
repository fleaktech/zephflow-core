...
public class KafkaSourceCommandFactory extends SourceCommandFactory {

  @Override
  public KafkaSourceCommand createCommand(String nodeId, JobContext jobContext) {
    JsonConfigParser<KafkaSourceDto.Config> configParser =
