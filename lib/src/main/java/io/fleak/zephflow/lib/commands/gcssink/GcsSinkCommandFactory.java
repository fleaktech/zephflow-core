...
public class GcsSinkCommandFactory extends CommandFactory {
  @Override
  public OperatorCommand createCommand(String nodeId, JobContext jobContext) {
    return new GcsSinkCommand(
        nodeId,
        jobContext,
        new JsonConfigParser<>(GcsSinkDto.Config.class),
        new GcsSinkConfigValidator(),
