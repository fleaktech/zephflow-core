...
public class AzureBlobSinkCommandFactory extends CommandFactory {
  @Override
  public OperatorCommand createCommand(String nodeId, JobContext jobContext) {
    return new AzureBlobSinkCommand(
        nodeId,
        jobContext,
        new JsonConfigParser<>(AzureBlobSinkDto.Config.class),
        new AzureBlobSinkConfigValidator(),
