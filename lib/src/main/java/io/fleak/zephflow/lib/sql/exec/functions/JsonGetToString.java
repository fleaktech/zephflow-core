...
public class JsonGetToString extends BaseFunction {

  public static final String NAME = "jsonGetToString";
  public TypeCast<String> castToString;

  public JsonGetToString(TypeSystem typeSystem) {
  ...
  public Object apply(List<Object> args) {
    ...
    if (key instanceof String) {
      try {
        ...
        return castToString.cast(datumMap.get(key));
      } catch (Throwable t) {
        return null;
      }
      ...
      try {
        ...
        return castToString.cast(datumMap.get((k.intValue())));
      } catch (Throwable t) {
        return null;
      }
    }
