 ...
 *
 * <p>For local FS, writes go via tmp-file + ATOMIC_MOVE. For S3/GCS, a plain PUT is atomic at the
 * object level — handled by extending {@link #writeBytes} when those backends land in Tasks 23-24.
 */
