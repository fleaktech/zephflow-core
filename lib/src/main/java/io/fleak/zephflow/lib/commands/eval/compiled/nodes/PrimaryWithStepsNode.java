...
/** Represents a primary expression (identifier, function call, etc.) followed by steps. */
public record PrimaryWithStepsNode(ExpressionNode primary, List<StepNode> steps)
    implements ExpressionNode {
  @Override
  public FleakData evaluate(EvalContext ctx) {
    FleakData value = primary.evaluate(ctx);
