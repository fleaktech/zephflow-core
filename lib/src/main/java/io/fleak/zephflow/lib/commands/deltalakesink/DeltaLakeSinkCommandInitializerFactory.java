...
public class DeltaLakeSinkCommandInitializerFactory
  ...
  protected CommandPartsFactory createCommandPartsFactory(
      ...
      String nodeId) {
    return new DeltaLakeSinkPartsFactory(
        metricClientProvider, jobContext, ((DeltaLakeSinkDto.Config) commandConfig));
  }
}
