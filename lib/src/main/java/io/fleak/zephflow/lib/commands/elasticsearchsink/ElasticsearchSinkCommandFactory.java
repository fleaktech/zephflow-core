...
public class ElasticsearchSinkCommandFactory extends CommandFactory {

  @Override
  public OperatorCommand createCommand(String nodeId, JobContext jobContext) {
    return new ElasticsearchSinkCommand(
        nodeId,
        jobContext,
        new JsonConfigParser<>(ElasticsearchSinkDto.Config.class),
        new ElasticsearchSinkConfigValidator());
  }
