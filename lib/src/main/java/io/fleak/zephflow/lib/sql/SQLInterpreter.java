...
public interface SQLInterpreter {
  ...
  static SQLInterpreter defaultInterpreter() {
    return SQLInterpreterImpl.DEFAULT;
  }

  Stream<Row> eval(Catalog catalog, CompiledQuery query);

  CompiledQuery compileQuery(String sql);
