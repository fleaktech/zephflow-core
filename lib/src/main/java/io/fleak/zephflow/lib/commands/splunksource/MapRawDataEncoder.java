...
public class MapRawDataEncoder implements RawDataEncoder<Map<String, String>> {

  @Override
  public SerializedEvent serialize(Map<String, String> sourceRecord) {
    try {
      byte[] bytes = OBJECT_MAPPER.writeValueAsBytes(sourceRecord);
