...
public final class Limit extends ExtTable {

  final long limit;

  public Limit(TypeSystem typeSystem, Table<Row> source, long limit) {
    super(typeSystem, source, source.getHeader());
    this.limit = limit;
  }
  ...
  public Iterator<Row> iterator() {
    return Streams.asStream(getSource().iterator()).limit(limit).iterator();
  }
}
