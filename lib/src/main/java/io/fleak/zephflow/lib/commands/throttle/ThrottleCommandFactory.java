...
public class ThrottleCommandFactory extends CommandFactory {
  @Override
  public OperatorCommand createCommand(String nodeId, JobContext jobContext) {
    return new ThrottleCommand(
        nodeId, jobContext, new ThrottleConfigParser(), new ThrottleConfigValidator());
  }
