...
public class BTrim extends BaseFunction {

  public static final String NAME = "btrim";

  public BTrim(TypeSystem typeSystem) {
  ...
  public Object apply(List<Object> args) {
    ...
    if (trimChars == null) return input.toString().trim();

    return input.toString().replaceAll("^[" + trimChars + "]+|[" + trimChars + "]+$", "");
  }
}
