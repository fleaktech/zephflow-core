...
/** Reads and writes {@link FsCheckpoint} through a {@link CheckpointClient}. */
public final class FsCheckpointStore {

  private FsCheckpointStore() {}

  public static FsCheckpoint load(CheckpointClient checkpointClient, String sourceId) {
