...
import io.fleak.zephflow.lib.commands.eval.EvaluatorFuncs.BinaryEvaluatorFunc;
...
public record BinaryOpNode(
    ExpressionNode left, ExpressionNode right, BinaryEvaluatorFunc<FleakData> evaluator)
    implements ExpressionNode {
  @Override
  public FleakData evaluate(EvalContext ctx) {
    return evaluator.evaluate(left.evaluate(ctx), right.evaluate(ctx));
  }
}
