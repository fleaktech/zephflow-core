...
public interface MiscUtils {
  ...
  String METADATA_FS_SOURCE_PREFIX = METADATA_PREFIX + "fs_source_";
  String METADATA_FS_SOURCE_URN = METADATA_FS_SOURCE_PREFIX + "urn";
  String METADATA_FS_SOURCE_RECORD_INDEX = METADATA_FS_SOURCE_PREFIX + "record_index";
  ...
  String COMMAND_NAME_SAMPLE = "sample";
