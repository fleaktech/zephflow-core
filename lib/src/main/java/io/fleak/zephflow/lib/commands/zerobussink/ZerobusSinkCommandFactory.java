...
public class ZerobusSinkCommandFactory extends CommandFactory {
  @Override
  public OperatorCommand createCommand(String nodeId, JobContext jobContext) {
    JsonConfigParser<ZerobusSinkDto.Config> configParser =
        new JsonConfigParser<>(ZerobusSinkDto.Config.class);
    var validator = new ZerobusSinkConfigValidator();
    return new ZerobusSinkCommand(nodeId, jobContext, configParser, validator);
  }
